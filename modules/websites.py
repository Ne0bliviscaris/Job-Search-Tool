...
search_links = {
    ...
    "inhire_data-ml-python": "https://inhire.io/?roles=it,big_data,data_science,etl_developer,machine_learning_engineer,backend_developer,bi,database_developer&technologies=7"
}
